		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SOW Tracker",
									"targetURL": "#comcandentechsowtracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcandentechsowtracker-display": {
								"semanticObject": "comcandentechsowtracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.candentech.sowtracker",
									"url": sap.ui.require.toUrl("com/candentech/sowtracker")
								}
							}
						}
					}
